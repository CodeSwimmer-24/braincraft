...
const options = [
    { title: 'Safety Performance System', price: '$200 per month, unlimited', color: 'green', short: "SPS" },
    { title: `Contractors/ Vendor's Safety Management System`, price: '$200 per month, unlimited 18+', color: 'orange', short: "CSMS" },
    { title: 'Auditing Management System', price: '$25 one-time', color: 'yellow', short: "AMS" },
    { title: 'Management Review Meeting', price: '$499 per year, unlimited 18+', color: 'purple', short: "MRM" },
    { title: 'Lag Indicator', price: '$300 per month, unlimited', color: 'green', short: "LAI" },
    { title: 'Lead Indicators', price: '$50 one-time', color: 'orange', short: "LEI" },
    { title: 'PPE Management System', price: '$250 per month, unlimited', color: 'yellow', short: "PMS" },
    { title: `Vendor's Selection Process`, price: '$250 per month, unlimited', color: 'yellow', short: "VSP" },
    { title: 'Legal Complinces', price: '$600 per year, unlimited', color: 'purple', short: "LC" },
    { title: 'Asset Mangement System', price: '$100 per month', color: 'green', short: "AMS" },
    // { title: 'Sustainability Supply Chain', price: '$150 per month, 18+', color: 'orange', short: "SPC" },
    // { title: 'Admin Control System', price: '$150 per month, 18+', color: 'orange', short: "ACS" },
];
            ...
            <div className="row">
                {
                    options.map((item, index) => (
                        <div className="card1" onClick={() => alert("Under Construction")}>
                        {/* <svg
